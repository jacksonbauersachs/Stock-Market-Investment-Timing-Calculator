...
def load_bitcoin_data():
    """Load Bitcoin data filtered to 2014-2025"""
    print("Loading Bitcoin dataset (2014-2025)...")
    df = pd.read_csv('Bitcoin/Data/2010_2025_Daily_Data_(BTC).csv')
    df['Date'] = pd.to_datetime(df['Date'])
    
    # Filter to 2014-2025 (full range)
    start_date = '2014-01-01'
    end_date = '2025-12-31'  # Include all data up to today
...
def create_bitcoin_chart(df):
    """Create Bitcoin price history chart (2014-2025)"""
    ...
    # Try a more subtle title that feels integrated with the chart
    ...
    # Save the plot
    save_path = 'Bitcoin/Visualizations/Images/bitcoin_price_history_2014_2025.png'
...
def main():
    """Main function"""
    print("Bitcoin Price History Chart (2014-2025)")
    print("="*50)
