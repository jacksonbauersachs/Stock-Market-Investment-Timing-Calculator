...
def create_ethereum_chart(df):
    ...
    # Customize the plot with professional styling - match Bitcoin chart exactly
    ax.set_xlabel('')  # Remove x-axis label
    ax.set_ylabel('')  # Remove y-axis label
    ax.set_title('Ethereum (2016-2025)', fontsize=16, fontweight='normal', color='#333333', pad=15)
