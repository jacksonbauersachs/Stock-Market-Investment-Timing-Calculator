...
class BitcoinMultiTierStrategy:
    def __init__(self):
        ...
        print("BITCOIN MULTI-TIER RESERVE STRATEGY")
        print("=" * 60)
    ...
    def simulate_multi_tier_strategy(self, reserve_pct, buy_tiers, sell_tiers, years):
        """
        Simulate multi-tier strategy
    ...
    def run_strategy_search(self):
        """Run search for best multi-tier strategies"""
        print("RUNNING MULTI-TIER STRATEGY SEARCH...")
        print("=" * 50)
        
        # Define parameter grids
        reserve_pcts = [10, 20, 30, 40, 50]  # % of monthly amount to reserve
        ...
        print(f"  Std Dev: ${dca_stats['std']:,.0f}")
        ...
        for reserve_pct in reserve_pcts:
            for buy_config in buy_tier_configs:
                for sell_config in sell_tier_configs:
                    strategy_results = self.simulate_multi_tier_strategy(
    ...
    def analyze_results(self, results_df, dca_stats, dca_results):
        ...
        print("\nTOP 10 MULTI-TIER STRATEGIES (by median improvement):")
        print("=" * 80)
        ...
        print(f"\n🏆 BEST MULTI-TIER STRATEGY DETAILS:")
        print("=" * 50)
        ...
        # Save results
        results_df.to_csv('Results/Bitcoin/bitcoin_multi_tier_strategy_results.csv', index=False)
...
def main():
    strategy = BitcoinMultiTierStrategy()
    ...
    print(f"\n📁 Results saved to: Results/Bitcoin/bitcoin_multi_tier_strategy_results.csv")
